...
\end{schemedisplay}
the transformation of a \scheme'wcm' body. No evaluation of this term occurs until the contextual information has been evaluated and applied. In the process of evaluation, the \scheme'mark-expr' is evaluated and prepended to the list of continutation marks.
...
\end{schemedisplay}
the expansion of an application. Both these terms are values, so are unaffected by the contextual information.

The elided reduction has the effect of preparing the terms for application.
\begin{schemedisplay}
...
With the contextual information given, the evaluation of \scheme'ccm' is simple:
\begin{schemedisplay}
((lambda (marks) marks)
 Cp[((CONS 1) NIL)])
\end{schemedisplay}
