...
A \scheme'wcm' expression of the form \scheme|(wcm mark-expr body-expr)| annotates the youngest portion of the continuation with \scheme'mark-value', the evaluation of \scheme'mark-expr', before evaluating \scheme'body-expr' to \scheme'body-value'. The entire expression takes on \scheme'body-value'.

Conceptually, a \scheme'ccm' expression of the form \scheme|(ccm)| traverses the continuation accumulating a list of annotations ascending in age.

For example, the program \scheme|(wcm (+ 1 2) (ccm))| evaluates as
\begin{schemedisplay}
(wcm (+ 1 2) (ccm))
(wcm 3 (ccm))
(wcm 3 '(3))
...
Continuation marks respect tail-call optimization.
